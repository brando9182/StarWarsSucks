...
/*---------------------------Definitions-------------------------------------*/
/*---------------------------Constants---------------------------------------*/
static char LONG_RANGE = 0;
static char SHORT_RANGE = 1;
static char LONG_RANGE_BACK = 0;
static char LONG_RANGE_FRONT = 1;
...
static float SHORT_DISTANCE_MAP_INCREMENT = 0.5;  //units in centimeters
...
static uint16_t SHORT_DISTANCE_MAPPING [76] = {626, 583, 543, 506, 472, 441, 413, 387, 363, 341, 321, 303, 287, 272,
...
static uint16_t LONG_DISTANCE_MAPPING [69] =  {568, 545, 523, 500, 478, 457, 435, 415, 395, 377, 359, 342, 326, 311,
