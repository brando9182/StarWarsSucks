...
//  drive(DRIVE_SPEED, DRIVE_SPEED);  //temp
//  state = STATE_3;
//}
//
...
//      set_motor_speed (RIGHT_MOTOR, 30, FORWARD);
//      miniState = 1;
//    }
//    if(miniState == 1 && front_distance_sensor() < 20){
//      set_motor_speed (LEFT_MOTOR, 1, FORWARD);
//      set_motor_speed (RIGHT_MOTOR, 1, REVERSE);
//    }
    if(button_state()){
      haltCode();
    }
